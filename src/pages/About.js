          ...
          <div className="about__article ">
            ...
            <div className="article__right-side pb-4">
              ...
              <div className="right-side__descr">
                ...
                <p>
                  <b>-</b> Осуществлял техническую и программную поддержку
                  пользователей, консультировал пользователей по вопросам работы
                  в локальной сети и программах общего назначения.
                </p>
              </div>
            </div>
          </div>
